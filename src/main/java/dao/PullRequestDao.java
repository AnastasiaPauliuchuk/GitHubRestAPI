...
public interface PullRequestDao {
        ...
        public static final String SQL_FIND_ALL_OPEN = "select * from " + PullRequest.TABLE_NAME + " where " + PullRequest.IS_OPEN_COLUMN + " = 1";
        public static final String SQL_UPDATE_ALL_CLOSE = "update " + PullRequest.TABLE_NAME + " set "+ PullRequest.IS_OPEN_COLUMN + "= 0";
